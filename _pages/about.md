...
I am a first-year PhD candidate at the HKUST NLP Group, working under the supervision of [Professor Junxian He](https://www.cs.hku.hk/~jxhe/). I am also a research intern at MINIMAX (February 2025 - Present).
...
2. **Junteng Liu**, Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. "**On the Perception Bottleneck of VLMs for Chart Understanding**". Arxiv, 2025. [[GitHub](https://github.com/Vision4Chart)]

3. **Junteng Liu**, Shiqi Chen, Yu Cheng, Junxian He. "**On the Universal Truthfulness Hyperplane Inside LLMs**". EMNLP 2024. [[GitHub](https://github.com/Universal_Truthfulness_Hyperplane)]
